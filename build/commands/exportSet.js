...
module.exports = {
    ...
    execute(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var [packs, error] = yield (0, MTGHelper_1.ExportSet)(setCode, sleeve);
            if (error) {
                ...
                var packsFile = new discord_js_1.AttachmentBuilder(Buffer.from(JSON.stringify(packs, null, 4)), { name: setCode + "_set.json" });
